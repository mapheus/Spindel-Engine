...
namespace Spindel {
	...
	void Renderer::Init()
	{
		...
		AssetManager::loadAsset(Loader::Type::shader, "PBR_STATIC", "assets/shaders/HazelPBR_Static.glsl");
		AssetManager::loadAsset(Loader::Type::shader, "GRID", "assets/shaders/HazelPBR_Static.glsl");
	...
	{
		SP_CORE_ASSERT(renderPass, "Render pass cannot be null!");
	...
	{
		SP_CORE_ASSERT(s_Data.m_ActiveRenderPass, "No active render pass! Have you called Renderer::EndRenderPass twice?");
